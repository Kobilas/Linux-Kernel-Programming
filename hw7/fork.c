...
long _do_fork(struct kernel_clone_args *args)
{
	 ...
	 * Counter used to limit the number of fork messages printed
	 * Variables used to calculate and later print the start time of each thread
	 */
	...
	/*
	 * Matthew Kobilas 04/28/20
	 * If we are under the fork creation printing limiter
	...
	/*
	 * Matthew Kobilas 04/28/20
	 * We have forked the thread
	 * Now we print the details of that thread, p
	 * The time of thread creation should be reasonably close to the time contained in
	 * /var/log/ where these messages are being printed to
